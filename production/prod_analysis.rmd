...
resultados. 
pese a que la ed y la sal son formas de redistribucion la gente no lo considera lo mismo.
...
> El modelo no converge ni en chipre ni en venezuela. 
...
```{r fig.cap = "Predictores de preferencias redistributivas"}
...
## Preferencias redistrivutivas. 

```{r fig.cap = "Preferencias redistributivas, desigualdad y mercantilizacion."}
...
plot_grid(list(plotredistgini, plotredistgini_outliers, plotredistfi, plotredistfi_outliers),margin = c(0.3,0.3,0.3,0.3), tags = c(" ", " ", " ", " ", " ", " "))

```


```{r fig.cap = "Preferencias redistributivas y creencias meritocraticas. "}
...
plot_grid(list(plotredistmerit, plotredistbmerit, plotredistunmerit, plotredistneed),margin = c(0.3,0.3,0.3,0.3), tags = c(" ", " ", " ", " ", " ", " "))
...
plotaccumfi<-plot_scatter(mer_pref_agg_ven, fi_index, accum, 
    title = "Libertad economica",
    	#dot.labels = merit_agg$v5c,
    	fit.line = "lm",
    	show.ci = TRUE)

plotaccumfi_outliers<-plot_scatter(mer_pref_agg_zaf,  fi_index, accum, 
    title = "Libertad economica (sin outliers)",
    	#dot.labels = merit_agg$v5c,
    	fit.line = "lm",
    	show.ci = TRUE)

plot_grid(list(plotaccumgini, plotaccumgini_outliers, plotaccumfi, plotaccumfi_outliers),margin = c(0.3,0.3,0.3,0.3), tags = c(" ", " ", " ", " ", " ", " "))

```


```{r fig.cap = "Preferencias de acumulacion y creencias meritocraticas."}
...
plot_grid(list(plotaccummerit, plotaccumbmerit, plotaccumunmerit, plotaccumneed),margin = c(0.3,0.3,0.3,0.3), tags = c(" ", " ", " ", " ", " ", " "))
...
```{r fig.cap = "Creencias meritocraticas y desigualdad."}
...
plot_grid(list(plotginimerit, plotginibmerit, plotginiunmerit, plotginineed),margin = c(0.3,0.3,0.3,0.3), tags = c(" ", " ", " ", " ", " ", " "))

```

```{r fig.cap = "Creencias meritocraticas y libertad economica."}

plotfi_indexmerit <- plot_scatter(mer_pref_agg, fi_index, merit,  
    title = "Percepcion meritocratica",
    #	dot.labels = merit_agg$v5c,
    	fit.line = "lm",
    	show.ci = TRUE)

plotfi_indexbmerit <-plot_scatter(mer_pref_agg, fi_index, bmerit,  
    title = "Preferencias meritocraticas",
    #	dot.labels = merit_agg$v5c,
    	fit.line = "lm",
    	show.ci = TRUE)
plotfi_indexunmerit <-plot_scatter(mer_pref_agg,fi_index, unmerit,  
    title = "Percepcion no meritocratica",
    	#dot.labels = merit_agg$v5c,
    	fit.line = "lm",
    	show.ci = TRUE)
plotfi_indexneed <-plot_scatter(mer_pref_agg,fi_index,  need,  
    title = "Preferenciasno meritocraticas ",
    	#dot.labels = merit_agg$v5c,
    	fit.line = "lm",
    	show.ci = TRUE)

plot_grid(list(plotfi_indexmerit, plotfi_indexbmerit, plotfi_indexunmerit, plotfi_indexneed),margin = c(0.3,0.3,0.3,0.3), tags = c(" ", " ", " ", " ", " ", " "))
...
results_1_redist_8 = lmer(redist ~ gini_neto + fi_index + merit + bmerit + unmerit + need + sstatus + movstatus + 1 +  (1| v5c), data = mer_pref, REML=F)

results_1_redist_9 = lmer(redist ~ gini_neto + fi_index + merit + bmerit + unmerit + need + sstatus + movstatus + univ + as.factor(quintile_miss)  + sex + age  + 1 +  (1| v5c), data = mer_pref, REML=F)

htmlreg(list(results_1_redist__1,results_1_redist__2, results_1_redist_3,results_1_redist_4,results_1_redist_5,results_1_redist_6,results_1_redist_7, results_1_redist_8, results_1_redist_9),caption = "Modelos con predictores")
...
results_3_redist_macro_bvi_2 = lmer(redist ~ univ + as.factor(quintile_miss) +	sstatus + movstatus + sex + age  + merit + bmerit + unmerit + need + merit*fi_index + gini_neto + 1 +  (1 + merit| v5c), data = mer_pref, REML=F)

htmlreg(list(results_1_redist_macro,results_2_redist_macro_bv, results_3_redist_macro_bvi,results_3_redist_macro_bvi_2), caption = "Pendiente aleatorea e interaccion entre niveles")
...
results_1_accum_8 = lmer(accum ~ gini_neto + fi_index + merit + bmerit + unmerit + need + sstatus + movstatus + 1 +  (1| v5c), data = mer_pref, REML=F)

results_1_accum_9 = lmer(accum ~ gini_neto + fi_index + merit + bmerit + unmerit + need + sstatus + movstatus + univ + as.factor(quintile_miss)  + sex + age  + 1 +  (1| v5c), data = mer_pref, REML=F)
...
results_3_accum_macro_bvi_2 = lmer(accum ~ univ + as.factor(quintile_miss) +	sstatus + movstatus + sex + age  + merit + bmerit + unmerit + need +  fi_index + merit*gini_neto + 1 +  (1 + merit| v5c), data = mer_pref, REML=F)
