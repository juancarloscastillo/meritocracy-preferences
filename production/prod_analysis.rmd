...
```{r fig.cap = "Preferencias redistributivas, desigualdad y mercantilizacion." , out.width = "200%"}
...
```{r fig.cap = "Preferencias redistributivas y creencias meritocraticas. " ,out.width = "200%"}
...
```{r fig.cap = "Preferencias de acumulacion y creencias meritocraticas." ,out.width = "200%"}
...
```{r fig.cap="Percepciones Meritocraticas", out.width = "200%"}
...
plot_grid(list(plotginimerit, plotginimerit_out, plotgfimerit, plotgfimerit_out),margin = c(0.3,0.3,0.3,0.3), tags = c(" ", " ", " ", " ", " ", " "))
```


```{r fig.cap="Preferencias meritocraticas" ,out.width = "200%" }
...
plot_grid(list(plotginibmerit, plotginibmerit_out, plotfibmerit, plotfibmerit_out),margin = c(0.3,0.3,0.3,0.3), tags = c(" ", " ", " ", " ", " ", " "))
```


```{r fig.cap="Percepcion no meritocratica" ,out.width = "200%"}
...
plot_grid(list(plotginiunmerit, plotginiunmerit_out, plotfiunmerit, plotfiunmerit_out),margin = c(0.3,0.3,0.3,0.3), tags = c(" ", " ", " ", " ", " ", " "))
```

```{r fig.cap="Preferencia no meritocratica",out.width = "200%"}
...
plot_grid(list(plotginineed, plotginineed_out, plotfineed, plotfineed_out),margin = c(0.3,0.3,0.3,0.3), tags = c(" ", " ", " ", " ", " ", " "))
```
...
```
Los efectos cambiam ligeramente. La variabe Fi_index nuevamente adquiere significacion. 
