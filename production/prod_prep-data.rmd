...
agregar un chunk  que no se corra (si se vea)  para dejar la opcion de descargar desde las paginas intucionales. 
...
comparar la variable fi de las dos bases de datos. (distribucion y na, y que coinsiden los paises)
...
mer_pref_polycor  cambiar nombre
