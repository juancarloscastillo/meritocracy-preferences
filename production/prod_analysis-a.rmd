...
plotredistmerit <- plot_scatter(mer_pref_agg,  merit, redist, 
                                ...
                                #	dot.labels = merit_agg$v5c,
                                fit.line = "lm",
                                show.ci = TRUE) + ylab("Redistribution preferences") + xlab("Meritocratic perception") 
...
plotredistbmerit <-plot_scatter(mer_pref_agg,  bmerit, redist, 
                                ...
                                #	dot.labels = merit_agg$v5c,
                                fit.line = "lm",
                                show.ci = TRUE) + ylab("Redistribution preferences") + xlab("Meritocratic preferences") 

plotredistunmerit <-plot_scatter(mer_pref_agg,  unmerit, redist, 
                                 title = "Redistribution and Unmeritocratic perception",
                                 #dot.labels = merit_agg$v5c,
                                 fit.line = "lm",
                                 show.ci = TRUE) + ylab("Redistribution preferences") + xlab("Unmeritocratic perception") 

plotredistneed <-plot_scatter(mer_pref_agg,  need, redist, 
                              title = "Redistribution and Need",
                              #dot.labels = merit_agg$v5c,
                              fit.line = "lm",
                              show.ci = TRUE) + ylab("Redistribution preferences") + xlab("Unmeritocratic preferences") 
...
plotaccumneed <-plot_scatter(mer_pref_agg,  need, accum, 
                             ...
                             #dot.labels = merit_agg$v5c,
                             fit.line = "lm",
                             show.ci = TRUE) + ylab("Accumulation preferences") + xlab("Unmeritocratic preferences")
...
plotfibmerit_out <- plot_scatter(mer_pref_agg_ven,fi_index,  bmerit,  
                                 ...
                                 #	dot.labels = mer_pref_agg_ven$v5c,
                                 fit.line = "lm",
                                 show.ci = TRUE)  + ylab("Meritocratic preferences") + xlab("Economic freedom index")+labs(caption = "Excluding outliers")
