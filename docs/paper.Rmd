...
Con el objetivo de promover los derechos humanos la Organización de las Naciones Unidas (ONU), ha firmado con múltiples países los Objetivos de Desarrollo Sustentable (ODS), en los cuales se destaca la importancia de disminuir la desigualdad y garantizar un acceso universal a salud y educación de calidad. El aumento de las desigualdades a nivel mundial y la reducción de los estados de bienestar, dan cuenta de una tendencia mundial incoherente con dichos objetivos. Si bien, han surgido múltiples movimientos sociales que demandan mayor redistribucion y gasto social, buena parte de la población considera legitimas las desigualdades sociales. En un contexto democrático, la opinión ciudadana posee un gran peso en la dirección de las políticas públicas. Por ello, opiniones que se oponen a políticas redistributivas y a un acceso igualitario a servicios elementales como salud y educación, pueden ser perjudiciales para la mantención y promoción de servicios públicos y gastos sociales. En consideracion de lo anterior, estudiar las creencias sobre la justicia social desde las ciencias sociales, puede aportar información a debates necesarios para garantizar los derechos humanos y el desarrollo sostenible.

Esta creciente desigualdad y las demandas por un mayor gasto redistributivo han motivado múltiples estudios sobre la legitimidad social de la desigualdad (Alesina and Angeletos 2005; Dimick, Rueda, and Stegmueller 2018).Estas investigaciones han destacado distintos aspectos ideológicos y contextuales que se relacionan con la justificación de la desigualdad. Respecto a las ideologías, algunas investigaciones han concluido que la percepcion de meritocracia legitima la desigualdad, justificándola en base al esfuerzo y el talento individual, desconsiderando la existencia de oportunidades desiguales (Kunovich y Slomczynski, 2007; Duru-Bellat y Tenret, 2012; Hadjar, 2008 ; Madeira et al. 2019). Este efecto podría deberse, en parte, a los prejuicios hacia los pobres que poseen quienes creen en la meritocracia. En torno a los efectos contextuales, podría pensarse que en sociedades con mayor desigualdad los ciudadanos exigirán mayor redistribucion (Meltzer y Richard 1981), no obstante, esto no siempre ocurre de dicho modo (Schröder 2017; Solt 2010; Solt et al. 2016). Por ejemplo, respecto a la salud, se ha demostrado que mayores niveles de desigualdad económica en salud fomentan creencias que justifican moralmente esta desigualdad (Immergut, & Schneider, 2020).

Frente a la creciente cantidad de investigaciones sobre las preferencias redistributivas y la meritocracia, el presente artículo busca aportar con un modelo que incorpore definiciones más precisas para ambos conceptos y un mayor énfasis en los efectos contextuales. Algunos artículos, al evaluar el efecto de las creencias meritocraticas en las opiniones sobre desigualdad y redistribucion, utilizan una definición simple de meritocracia, la cual no diferencia entre percepciones o preferencias y considera aspectos meritocraticos y no meritocraticos como polos de un mismo continuo. Considerar las creencias meritocraticas como un constructo unidimensional es una decisión metodológica que posee mucha evidencia en contra (Kunovich y Slomczynski, 2007; Reynolds y Xian, 2014; ). En términos técnicos, el problema de esta operacionalización es que no permite controlar los efectos de percepciones y preferencias entre sí, lo cual puede llevar a conclusiones erróneas sobre el fenómeno. En torno a los efectos contextuales, es comprensible que la relación entre preferencias redistributivas y creencias meritocraticas no se de igual en todos los países. Al respecto, suponemos que distintos niveles de desigualdad, así como distintos niveles de libertad económica, serán capaces de moderar la relación entre percepciones meritocraticas y preferencias redistributivas. Se espera que en países con menor desigualdad, mayores percepciones meritocraticas fomenten menores preferencias redistributivas, mientras que en sociedades con mayores niveles de desigualdad la influencia de la normalización de la inequidad es tan extendida como parámetro moral, que incluso quienes perciben que el éxito no es fruto del mérito propio, poseerán una baja preferencia por redistribucion, no existiendo mayor relación entre ambas variables en estos contextos.

En vista de todo lo anterior, nuestras preguntas de investigación son: 

  +  ¿Cómo se relacionan las distintas dimensiones de la ideologia meritocraticas con las preferencias redistributivas vía impuestos y mediante el acceso universal a derechos sociales como educación y salud?
  +   ¿En qué medida la desigualdad de los países y su libertad económica logran explicar la diferencia entre países de la relación entre percepciones meritocraticas y preferencias redistributivas?

Para responder estas preguntas realizaremos un análisis multinivel con interacciones entre niveles, a partir de los datos del módulo de desigualdad social del Programa internacional de encuestas sociales (ISSP). Para este análisis contamos con un total de 55021 encuestados pertenecientes a 40 países. Como se señaló anteriormente, es necesario incorporar una conceptualización más precisa de los conceptos y una metodología que permita explicar las diferencias en la relación meritocracia-redistribucion en distintos países. Para abordar estas necesidades teóricas, se trabajará en términos metodológicos con análisis factoriales, para evaluar la validez de los constructos,  y con regresiones multinivel, para evaluar los efectos contextuales, las pendientes aleatorias y las interacciones entre niveles. 

Como principales hallazgos de la investigación, podemos decir que las preferencias redistributivas son influenciadas negativamente por la percepcion de meritocracia, aunque están positivamente relacionadas con las preferencias meritocraticas, las percepciones no meritocraticas de desigualdad de oportunidades y con la preferencia no meritocratica basada en la necesidad como criterio de pago. Respecto a la preferencia por distribución económicamente desigual de servicios básicos (educación y salud), las percepciones meritocraticas y no meritocraticas poseen un efecto positivo, mientras que las preferencias meritocraticas y no meritocraticas poseen un efecto negativo. 
...
La variable dependiente preferencias redistributivas es medida a partir de un conjunto de cinco ítems tipo Likert que forman dos variables latentes. Se le pregunto al encuestado su grado de acuerdo con cada uno de los ítems, las categorías de respuesta van desde “Completely disagree” (1) to “Completely agree” (5). Tres indicadores se agrupan en el factor “preferencias redistributivas” y dos en el factor “preferencias por la mercantilización de servicios básicos”. Tal como se presenta en la Figura X el primer factor, preferencias redistributivas, incorpora indicadores relativos al rol que los ciudadanos esperan del Estado en tres aspectos: reducción de la desigualdad, estándares mínimos de dignidad a desempleados y aplicación de impuestos más altos a los más ricos. Indicadores de este tipo han sido usados en investigaciones similares, abordando las expectativas de los ciudadanos sobre el actuar del gobierno (10.1016/j.ejpoleco.2020.101880; 10.1007/s11211-020-00354-9). El segundo factor, preferencias por la mercantilización de servicios básicos, incorpora indicadores que refieren a la posibilidad de acceder a servicios de mejor calidad por medio del pago en dos ámbitos: la salud y la educación. Se testeó un análisis factorial confirmatorio de ambos factores, el cual, presentó un ajuste adecuado (CFI = 0.999, RMSEA = 0.043, $\chi2$ (df = 4) = 363.069, p = 0.000). Las dos variables dependientes fueron producidas imputando valores predichos a cada caso a partir de las variables latentes, creando así dos variables de puntajes factoriales.
3.3 Variables independientes.

Las variables independientes principales en el nivel individual refieren a creencias meritocráticas. Éstas han sido operacionalizadas en cuatro factores considerando las diferencias entre preferencias y percepciones (duru, profe), y entre creencias meritocráticas y creencias no meritocráticas. Las variables latentes estimadas son: preferencia meritocrática del pago, preferencias no meritocráticas basadas en las necesidades, percepción meritocrática y percepción no meritocrática. Esta última variable es una variable latente de segundo orden estimada a partir de tres otras variables latentes relativas tres desigualdades adscritas: de origen socioeconómico, de género y de raza. Para medir estos cuatro factores hemos utilizado las variables del módulo de desigualdad social de la ISSP tradicionalmente utilizadas para medir estas creencias, la escala “get ahead” y la escala “ought to earn”.
 Adicionalmente, se agregaron a los análisis variables como el quintil de ingreso, el estatus subjetivo, si cursó estudios universitarios (o no), el género y edad. A nivel país se utiliza la variable Gini neto de la base de datos SWIID y el índice de libertad para la acción económica (fi_index) de la base QOG. La variable GINI de mercado representa la desigualdad que es producida por la distribución de la renta dentro del mercado, sin considerar la disminución de la desigualdad generada por los impuestos y la redistribución, a diferencia del Gini neto, que sí incorpora dicha reducción (citar swiid). El índice de libertad para la acción económica fi_index busca representar la mercantilización de los servicios en general (citar fi_index).

## Enfoque y técnicas de análisis.

Como técnica analítica se utilizaron regresiones multinivel, ya que estas nos permiten comprender el efecto de los contextos nacionales e institucionales (http://www.jstor.org/stable/2779798), los cuales son fundamentales para explicar las preferencias redistributivas. A partir de los análisis multinivel se estimó el efecto de las creencias meritocraticas sobre las preferencias redistributivas. Se evalúa como varia la relación entre percepciones meritocraticas y preferencias redistributivas en distintos países y posteriormente se estimó una interacción para evaluar la capacidad de variables macro como el Gini o la libertad económica, de explicar la variación de la pendiente entre meritocracia y redistribucion. Más específicamente, se provo, en primer lugar, el efecto de moderación que produce la desigualdad económica en la relación entre percepciones meritocraticas y preferencias redistributivas, y en segundo lugar, el efecto de moderación que produce la libertad económica, en la relación entre percepcion meritocratica y preferencias por la mercantilización de servicios básicos. Para obtener resultados robustos respecto a las interacciones se siguieron las recomendaciones de Aguinis,  Gottfredson y Culpepper (2013) doi :10.1177/0149206313478188 
