...
La igualdad de oportunidades no solo fomenta la cohesión social y la sostenibilidad de las democracias (PNUD, 2017), sino que también fomenta el crecimiento económico mediante el aprovechamiento del capital humano de toda la población (ONU, 2016). Para mejorar la igualdad de oportunidades es necesario garantizar el acceso universal a educación y salud de calidad, además de disminuir la desigualdad económica a través de políticas redistributivas (ONU, 2018). Mejorar la igualdad de oportunidades mediante redistribución y acceso universal a servicios sociales requiere, en el contexto de la democracia, una opinión pública que esté dispuesta a respaldar estas políticas [citar]. No obstante, algunas investigaciones han evidenciado que considerables fracciones de la población legitiman los actuales niveles de desigualdad y justifican el acceso desigual a servicios elementales como salud (Immergut, Schneider, 2020; Becker, 2020). En este contexto, para fomentar el apoyo a políticas que disminuyan la desigualdad de oportunidades, es necesario comprender qué factores se relacionan con mayores preferencias redistributivas y de acceso universal a salud y educación de calidad. 


La creciente desigualdad y las demandas por un mayor gasto redistributivo desde ciertos sectores han motivado múltiples estudios sobre la legitimidad social de la desigualdad (Alesina and Angeletos 2005; Dimick, Rueda, and Stegmueller 2018). Estas investigaciones han destacado distintos aspectos ideológicos y contextuales que se relacionan con la justificación de la desigualdad. Respecto a las ideologías, algunas investigaciones han concluido que la percepción de meritocracia legitima la desigualdad, justificándose en base al esfuerzo y el talento individual, menospreciando la relevancia de las oportunidades desiguales (Kunovich y Slomczynski, 2007; Duru-Bellat y Tenret, 2012; Hadjar, 2008 ; Madeira et al. 2019). Esta relación podría deberse, en parte, a los prejuicios hacia los pobres que poseen quienes creen en la meritocracia. En torno a la importancia del contexto, podría pensarse que en sociedades con mayor desigualdad los ciudadanos exigirán mayor redistribución (Meltzer y Richard 1981), no obstante, esto no siempre ocurre de dicho modo (Schröder 2017; Solt 2010; Solt et al. 2016). Por ejemplo, respecto a la salud, se ha demostrado que mayores niveles de desigualdad económica en salud se asocian a creencias que justifican moralmente esta desigualdad (Immergut, Schneider, 2020).
...
Posteriormente utilizando las herramientas multinivel se evaluó la capacidad de la desigualdad económica y la libertad económica de moderar ambas relaciones planteadas. En primer lugar, se aleatorizaron las pendientes, comprobando que el sentido y la fuerza de los efectos varían de un país a otro. Para explicar esta variación, se utilizaron interacciones multinivel para evaluar la capacidad de la desigualdad del país de moderar la relación entre percepciones  meritocráticas y preferencias redistributivas. Similarmente, se evaluó la capacidad de la libertad económica de moderar la relación entre percepciones meritocráticas y preferencias por la mercantilización de servicios básicos. Para obtener resultados robustos en las interacciones se siguieron las recomendaciones de Aguinis, Gottfredson y Culpepper (2013),  doi :10.1177/0149206313478188
...
El software de análisis estadístico utilizado fue R (version 4.00) y la plataforma de edición Github. Para el análisis factorial confirmatorio utilizamos el paquete lavaan (version 0.6-3; Rosseel, 2020), mientras que para los análisis multinivel recurrimos al paquete lme4 (version 1.1-23; Bates et al. 2019). provided by The Data Catalogue DBK (https://dbk.gesis.org/dbksearch).
